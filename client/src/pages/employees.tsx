    ...
    <div className="flex h-screen bg-theme-primary-lighter">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <Header 
          ...
          subtitle="إدارة المستخدمين والأذونات"
          onCreateProduct={() => {}}
          onCreateLandingPage={() => {}}
        />
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <Card className="theme-border bg-theme-primary-lighter">
            <CardContent className="p-12 text-center">
              ...
              <h3 className="text-lg font-medium text-theme-primary mb-2">إدارة الموظفين</h3>
              <p className="text-gray-500 dark:text-gray-400">قريباً - نظام إدارة الموظفين قيد التطوير</p>
            </CardContent>
          </Card>
        </main>
      </div>
