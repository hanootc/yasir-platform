...
export function PlatformThemeSelector() {
  const { 
    platformTheme, 
    isLoading, 
    toggleDarkMode, 
  ...
  const currentTheme = themeOptions.find(theme => theme.id === platformTheme?.themeId) || themeOptions[0];
        ...
        <DropdownMenuContent align="end" className="w-72">
          <div className="p-2">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-medium">اختيار لون الثيم</span>
            </div>
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between">
                      ...
                      {platformTheme?.themeId === theme.id && (
